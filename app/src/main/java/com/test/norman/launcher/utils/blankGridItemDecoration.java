...
public class blankGridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public blankGridItemDecoration(int gridSpacingPx, int gridSize, Drawable divider, int paddingInPixels) {
