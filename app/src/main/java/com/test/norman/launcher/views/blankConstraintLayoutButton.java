 ...
 * EXACTLY the same code as {@link blankButton}, but extends {@link ConstraintLayout} instead.
 * for more details, head to {@link blankButton}
 */
public class blankConstraintLayoutButton extends ConstraintLayout implements blankButtonInterface, View.OnLongClickListener, View.OnClickListener {
    ...
    public blankConstraintLayoutButton(Context context) {
        super(context);
    ...
    @SuppressLint("ClickableViewAccessibility")
    public blankConstraintLayoutButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.sharedPreferences = context.getSharedPreferences(D.blank_PREFS, Context.MODE_PRIVATE);
        this.longPresses = sharedPreferences.getBoolean(BPrefs.LONG_PRESSES_KEY, BPrefs.LONG_PRESSES_DEFAULT_VALUE);
        this.longPressesShorter = sharedPreferences.getBoolean(BPrefs.LONG_PRESSES_SHORTER_KEY, BPrefs.LONG_PRESSES_SHORTER_DEFAULT_VALUE);
    ...
    @SuppressLint("ClickableViewAccessibility")
    public blankConstraintLayoutButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
