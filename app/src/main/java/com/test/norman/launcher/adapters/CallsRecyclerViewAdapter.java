...
import com.test.norman.launcher.activities.contacts.AddContactActivity;
...
import com.test.norman.launcher.utils.RandomColorMaker;
...
public class CallsRecyclerViewAdapter extends ModularRecyclerView.ModularAdapter<CallsRecyclerViewAdapter.ViewHolder> {
    ...
    public CallsRecyclerViewAdapter(List<Call> callList, blankActivity activity) {
        ...
        theme.resolveAttribute(R.attr.blank_decoration_on_button, typedValue, true);
        textColorOnRegular = typedValue.data;
        theme.resolveAttribute(R.attr.blank_background, typedValue, true);
