 ...
 */
public class AddAlarmActivity extends com.test.norman.launcher.activities.blankActivity {
    ...
    private blankButton bt_alarm_submit;
    private EditText alarm_edit_name;
    private blankNumberChooser chooser_hours, chooser_minutes;
