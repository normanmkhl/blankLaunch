...
public class ContactRecyclerViewAdapter extends ModularRecyclerView.ModularAdapter<ContactRecyclerViewAdapter.ViewHolder> {
    ...
    public ContactRecyclerViewAdapter(blankActivity activity, Cursor cursor, RecyclerView recyclerView, @IntRange(from = MODE_DEFAULT, to = MODE_SHARE) int mode) {
        this.mode = mode;
        ...
        theme.resolveAttribute(R.attr.blank_text_on_gold, typedValue, true);
