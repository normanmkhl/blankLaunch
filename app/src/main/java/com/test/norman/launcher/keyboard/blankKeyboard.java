...
public abstract class blankKeyboard extends FrameLayout {
    ...
    @Keep
    public blankKeyboard(final Context context, final View.OnClickListener onClickListener, final Runnable backspaceRunnable, final int imeOptions) {
        super(context);
    ...
    public static blankKeyboard newInstance(int language, Context context, View.OnClickListener onClickListener, Runnable backspaceRunnable, int imeOptions) {
        switch (language) {
    ...
    protected void imeOptionsChanged(int imeOptions) {
        ...
        if (blankInputMethodService.defaultEditorActionExists(imeOptions)) {
            ...
            public void run() {
                try {
                    ...
                    while (true) {
                        ...
                        counter++;
                        vibrator.vibrate(60);
                        blankKeyboard.this.backspaceRunnable.run();
                        if (counter > 100)
                            return;
                    }
        ...
        return new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_UP)
                    if (blankKeyboard.this.backspaceRunnable != null)
