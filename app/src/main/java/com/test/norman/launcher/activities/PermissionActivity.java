...
public class PermissionActivity extends blankActivity {
    ...
    protected void onCreate(@Nullable final Bundle savedInstanceState) {
        ...
        blankTitleBar blankTitleBar = findViewById(R.id.blank_title_bar);
        blankTitleBar.getBt_back().setOnClickListener(v -> calmyBDB());
    ...
    private void obtainPermissionList() {
        ...
        if ((requiredPermissions & PERMISSION_REQUEST_INSTALL_PACKAGES) != 0) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O && BuildConfig.FLAVOR.equals("blankUpdates")) {
