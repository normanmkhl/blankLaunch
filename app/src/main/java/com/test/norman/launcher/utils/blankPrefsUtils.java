...
import static com.test.norman.launcher.utils.BPrefs.CUSTOM_ALARMS_KEY;
import static com.test.norman.launcher.utils.BPrefs.CUSTOM_APPS_KEY;
import static com.test.norman.launcher.utils.BPrefs.CUSTOM_APP_KEY;
import static com.test.norman.launcher.utils.BPrefs.CUSTOM_ASSISTANT_KEY;
import static com.test.norman.launcher.utils.BPrefs.CUSTOM_CAMERA_KEY;
import static com.test.norman.launcher.utils.BPrefs.CUSTOM_CONTACTS_KEY;
import static com.test.norman.launcher.utils.BPrefs.CUSTOM_DIALER_KEY;
import static com.test.norman.launcher.utils.BPrefs.CUSTOM_MESSAGES_KEY;
import static com.test.norman.launcher.utils.BPrefs.CUSTOM_PHOTOS_KEY;
import static com.test.norman.launcher.utils.BPrefs.CUSTOM_PILLS_KEY;
import static com.test.norman.launcher.utils.BPrefs.CUSTOM_RECENTS_KEY;
import static com.test.norman.launcher.utils.BPrefs.CUSTOM_VIDEOS_KEY;
import static com.test.norman.launcher.utils.BPrefs.EMERGENCY_BUTTON_VISIBLE_DEFAULT_VALUE;
import static com.test.norman.launcher.utils.BPrefs.EMERGENCY_BUTTON_VISIBLE_KEY;
import static com.test.norman.launcher.utils.BPrefs.LONG_PRESSES_DEFAULT_VALUE;
import static com.test.norman.launcher.utils.BPrefs.LONG_PRESSES_KEY;
import static com.test.norman.launcher.utils.BPrefs.LOW_BATTERY_ALERT_DEFAULT_VALUE;
import static com.test.norman.launcher.utils.BPrefs.LOW_BATTERY_ALERT_KEY;
import static com.test.norman.launcher.utils.BPrefs.NOTE_VISIBLE_DEFAULT_VALUE;
import static com.test.norman.launcher.utils.BPrefs.NOTE_VISIBLE_KEY;
import static com.test.norman.launcher.utils.BPrefs.PAGE_TRANSFORMERS_DEFAULT_VALUE;
import static com.test.norman.launcher.utils.BPrefs.PAGE_TRANSFORMERS_KEY;
import static com.test.norman.launcher.utils.BPrefs.STATUS_BAR_DEFAULT_VALUE;
import static com.test.norman.launcher.utils.BPrefs.STATUS_BAR_KEY;
import static com.test.norman.launcher.utils.BPrefs.TOUCH_NOT_HARD_DEFAULT_VALUE;
import static com.test.norman.launcher.utils.BPrefs.TOUCH_NOT_HARD_KEY;
import static com.test.norman.launcher.utils.BPrefs.VIBRATION_FEEDBACK_DEFAULT_VALUE;
import static com.test.norman.launcher.utils.BPrefs.VIBRATION_FEEDBACK_KEY;

public class blankPrefsUtils {
    ...
    public boolean equals(Object o) {
        ...
        blankPrefsUtils that = (blankPrefsUtils) o;
