 ...
 * EXACTLY the same code as {@link blankButton}, but extends {@link androidx.appcompat.widget.AppCompatImageView} instead.
 * for more details, head to {@link blankButton}
 */
public class blankImageButton extends androidx.appcompat.widget.AppCompatImageView implements blankButtonInterface, View.OnLongClickListener, View.OnClickListener {
    ...
    public blankImageButton(Context context) {
        super(context);
    ...
    public blankImageButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.sharedPreferences = context.getSharedPreferences(D.blank_PREFS, Context.MODE_PRIVATE);
        this.longPresses = sharedPreferences.getBoolean(BPrefs.LONG_PRESSES_KEY, BPrefs.LONG_PRESSES_DEFAULT_VALUE);
        this.longPressesShorter = sharedPreferences.getBoolean(BPrefs.LONG_PRESSES_SHORTER_KEY, BPrefs.LONG_PRESSES_SHORTER_DEFAULT_VALUE);
    ...
    public blankImageButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
