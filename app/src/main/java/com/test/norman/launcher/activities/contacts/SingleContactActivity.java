...
import com.test.norman.launcher.activities.SOSActivity;
import com.test.norman.launcher.adapters.CallsRecyclerViewAdapter;
import com.test.norman.launcher.databases.calls.Call;
...
import com.test.norman.launcher.views.ScrollingHelper;
 ...
 */
public class SingleContactActivity extends blankActivity {
    ...
    protected void onStart() {
        ...
        blankTitleBar.setTitle(contact.getName());
        setupBar();
    ...
    private void inflatePhones() {
        ...
        for (final Pair<Integer /*Type*/ , String> pair : contact.getPhoneList()) {
            ...
            final blankLinearLayoutButton call = layout.findViewById(R.id.call);
            final blankLinearLayoutButton message = layout.findViewById(R.id.message);
    ...
    private void inflateMails() {
        ...
        for (final String phone : contact.getMailList()) {
            ...
            final TextView tv_value = layout.findViewById(R.id.tv_value);
            final blankLinearLayoutButton mail = layout.findViewById(R.id.mail);
    ...
    private void inflateAdders() {
        ...
        blankTitleBar.setGold(contact.isFavorite());
        Toggeler.newTextImageToggeler(
                favorite,
    ...
    private void inflateAddresses() {
        for (Pair<Integer, String[]> pair : contact.getAddressList()) {
            ...
            final blankPictureTextButton button = layout.findViewById(R.id.address_button);
    ...
    private void inflateHistory(List<Call> callList) {
        ...
        final blankPictureTextButton show = view.findViewById(R.id.bt_show);
