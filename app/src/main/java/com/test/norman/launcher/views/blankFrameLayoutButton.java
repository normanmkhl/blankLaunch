 ...
 * {@link blankFrameLayoutButton#setOnLongClickListener(OnLongClickListener)} is deprecated,
 * use {@link blankFrameLayoutButton#setOnClickListener(OnClickListener)} instead.
 */
public class blankFrameLayoutButton extends FrameLayout implements blankButtonInterface, View.OnLongClickListener, View.OnClickListener {
    ...
    public blankFrameLayoutButton(Context context) {
        super(context);
    ...
    public blankFrameLayoutButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.sharedPreferences = context.getSharedPreferences(D.blank_PREFS, Context.MODE_PRIVATE);
        this.longPresses = sharedPreferences.getBoolean(BPrefs.LONG_PRESSES_KEY, BPrefs.LONG_PRESSES_DEFAULT_VALUE);
        this.longPressesShorter = sharedPreferences.getBoolean(BPrefs.LONG_PRESSES_SHORTER_KEY, BPrefs.LONG_PRESSES_SHORTER_DEFAULT_VALUE);
    ...
    public blankFrameLayoutButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
