 ...
 * {@link blankButton#setOnLongClickListener(android.view.View.OnLongClickListener)}
 * and {@link blankButton#setOnTouchListener(android.view.View.OnTouchListener)} are deprecated,
 * use {@link blankButton#setOnClickListener(android.view.View.OnClickListener)} instead.
 */
public class blankButton extends androidx.appcompat.widget.AppCompatTextView implements View.OnLongClickListener, View.OnClickListener, blankButtonInterface {
    ...
    public blankButton(Context context) {
        super(context);
    ...
    public blankButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.sharedPreferences = context.getSharedPreferences(D.blank_PREFS, Context.MODE_PRIVATE);
        this.longPresses = sharedPreferences.getBoolean(BPrefs.LONG_PRESSES_KEY, BPrefs.LONG_PRESSES_DEFAULT_VALUE);
        this.longPressesShorter = sharedPreferences.getBoolean(BPrefs.LONG_PRESSES_SHORTER_KEY, BPrefs.LONG_PRESSES_SHORTER_DEFAULT_VALUE);
    ...
    public blankButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
